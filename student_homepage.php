    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="student_homepage.php" class="logo">
          ...
          <span class="logo-lg"><b>Utkal University</b></span>
        </a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              <a href="academics.php">
                <i class="fa fa-dashboard"></i> <span>Academics</span></i>
              </a>
              <!--
              <ul class="treeview-menu">
                <li><a href="index.html"><i class="fa fa-circle-o"></i>Academic Session 1</a></li>
                <li class="active"><a href="index2.html"><i class="fa fa-circle-o"></i>Academic Session 2</a></li>
              </ul> -->
            </li>
            <li class="treeview">
              <a href="#">
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2014-2015 <a href="#">Utkal University</a>.</strong> All rights reserved.
      </footer>
